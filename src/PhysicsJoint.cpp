...
PhysicsJoint::PhysicsJoint(World* world, PhysicsBody* body1, PhysicsBody* body2, float body1X, float body1Y, float body2X, float body2Y, bool inMeters, bool collide)
	:world(world), body1(body1), body2(body2)
{
	...
	joint = (b2WeldJoint*)world->getPhysWorld()->CreateJoint(&jointDef);
	body1->addJoint(this);
	body2->addJoint(this);
}
...
{
	world->getPhysWorld()->DestroyJoint(joint);
